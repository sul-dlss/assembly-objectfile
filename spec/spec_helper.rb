...
TEST_DPG_SPECIAL_PDF1=File.join(TEST_INPUT_DIR,'oo000oo0001_book.pdf')
TEST_DPG_SPECIAL_PDF2=File.join(TEST_INPUT_DIR,'oo000oo0001_31_001.pdf')
TEST_DPG_SPECIAL_TIF=File.join(TEST_INPUT_DIR,'oo000oo0001_50_001.tif')
